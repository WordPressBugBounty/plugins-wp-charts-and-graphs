	...
	class pantherius_wp_charts_settings extends pantherius_wp_charts {
		...
		**/
		...
		public function pantherius_wp_charts_settings_page() {
			if ( ! current_user_can( 'manage_options' ) ) {
				wp_die( esc_html__( 'You do not have sufficient permissions to access this page.', 'wp-charts-and-graphs' ) );
			}
			...
			add_settings_field( 'pantherius_wp_charts-setting_include_files', esc_html__( 'Include Plugin Files to Specified Pages Only (comma separated list of page IDs - except home page)', 'wp-charts-and-graphs' ), array($this, 'settings_field_input_textarea'), 'pantherius_wp_charts', 'pantherius_wp_charts-section', array( 'field' => 'setting_include_files', 'field_value' => '', 'other' => 'rows="3" cols="70"' ) );
			add_settings_field('pantherius_wp_charts-setting_exclude_files', esc_html__( 'Exclude Plugin Files from Specified Pages (comma separated list of page IDs - except home page)', 'wp-charts-and-graphs' ), array( $this, 'settings_field_input_textarea'), 'pantherius_wp_charts', 'pantherius_wp_charts-section', array( 'field' => 'setting_exclude_files', 'field_value' => '', 'other' => 'rows="3" cols="70"' ) );
		...
		**/		
		public function add_menu() {
			...
			add_submenu_page( 'pantherius_wp_charts', 'Charts and Graphs', esc_html__( 'Generate Chart', 'wp-charts-and-graphs' ), 'manage_options', 'pantherius_wp_charts', array( $this, 'plugin_settings_page' ) );
			add_submenu_page( 'pantherius_wp_charts', 'Charts and Graphs', esc_html__( 'Settings', 'wp-charts-and-graphs' ), 'manage_options', 'pantherius_wp_charts_settings', array( $this, 'pantherius_wp_charts_settings_page' ) );
		}
